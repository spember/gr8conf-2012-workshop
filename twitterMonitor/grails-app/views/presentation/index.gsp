...
<body>
    ...
    <div id="html5_3" class="slide">
        ...
        <h3 class="animate-in"  data-animation="fly-in-right">USABILITY!</h3>
    </div>
    ...
    <div id="futureProof_2" class="slide">
        ...
        <div class="row animate-build" data-build="1">
            <img src="${resource(dir: 'images/slides', file: 'dialup.png')}" alt="Dialup, gross"/>
            <p class="right">Low / Slow Bandwidth, 'Lo-fi' UX</p>
        </div>
